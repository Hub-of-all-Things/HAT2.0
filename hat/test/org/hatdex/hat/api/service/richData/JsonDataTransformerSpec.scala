...
class JsonDataTransformerSpec extends AnyFlatSpec with Matchers {
  ...
  "JSON mappers" should "remap from simple fields to flat json" in new JsonDataTransformerContext {
    ...
    (resultJson.get \ "data" \ "newField").as[String] should equal("anotherFieldValue")
    (resultJson.get \ "data" \ "arrayField").as[List[String]] should contain("objectFieldArray3")
    (resultJson.get \ "data" \ "onemore").as[String] should equal("objectFieldArray2")
  }
  ...
  it should "remap array objects" in new JsonDataTransformerContext {
    ...
    (resultJson.get \ "data" \ "newField").as[String] should equal("value")
    (resultJson.get \ "data" \ "simpleArray").as[List[String]] should contain("objectFieldArray3")
    ((resultJson.get \ "newArray")(0) \ "mapTo").as[String] should equal("subObject1")
    ((resultJson.get \ "newArray")(1) \ "anotherProperty").as[String] should equal("subObject2-2")
  }
  ...
  it should "silently ignore missing fields" in new JsonDataTransformerContext {
    ...
    (resultJson.get \ "data" \ "newField").as[String] should equal("value")
    (resultJson.get \ "data" \ "otherField").toOption should not be 'defined
  }
  ...
  it should "silently ignore missing arrays" in new JsonDataTransformerContext {
    ...
    (resultJson.get \ "data" \ "newField").as[String] should equal("value")
    (resultJson.get \ "newArray").toOption should not be 'defined
  }
